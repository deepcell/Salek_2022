...
# Note: see Supplementary file for the data used in Fig3D
cov_mb1 <- read.csv("DTC_3_1mb.csv", header = F, as.is = T)
names(cov_mb1) <- c("cov","chrom","pos_mb","sample_name")
samples1 <- unique(cov_mb1$sample_name)

# also read in 12878 data
# Note: see Supplementary file for the data used in Fig3E and 3F
